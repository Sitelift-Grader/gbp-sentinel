            ...
            if existing:
                ...
                db_v2.update(
                    ...
                    biz_id,
                    {
                        ...
                        "canonical_url": p["website"] if p["website"] != UNKNOWN else existing.get("canonical_url"),
                    },
                ...
                biz_id = db_v2.insert(
                    "businesses",
                    {
                        ...
                        "canonical_url": p["website"] if p["website"] != UNKNOWN else None,
                        "domain": clean_domain,
